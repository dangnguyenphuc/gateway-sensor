...
client = pymongo.MongoClient("mongodb+srv://nhatminhkh2602:smarthome2023@cluster0.mfwrjvy.mongodb.net/?retryWrites=true&w=majority&ssl=true&ssl_cert_reqs=CERT_NONE")
db = client["SmartHome"]
