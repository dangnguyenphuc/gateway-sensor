...
client = pymongo.MongoClient("mongodb+srv://nhatminhkh2602:smarthome2023@cluster0.mfwrjvy.mongodb.net/?retryWrites=true&w=majority")
db = client["SmartHome"]

user_collection = db["user"]
# results = user_collection.find({"firstName":"Nhat"})
# for res in results: 
#     print(res)
################ DATA QUERY EXAMPLE ################
