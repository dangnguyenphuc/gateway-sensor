...
from gateway import client, bbc_port, ser, processData
from gateway import *
    ...
    with sr.Microphone() as source:
        try:
            ...
            if predictions[0][0] > 0.5:
                ...
                ser.write("!FAN:ON:".encode())
                return
            else: 
                print("OFF")
                client.publish(FEED, "OFF")
                ser.write("!FAN:OFF#".encode())
                return
