...
def my_mainloop():
    data1['country'].append(chr(random.randint(1, 255)))
    data1['gdp_per_capita'].append(chr(random.randint(40000, 50000)))
    df1 = pd.DataFrame(data1)
    ...
    root.after(1000, my_mainloop)  # run again after 1000ms (1s)

root.after(1000, my_mainloop) # run first time after 1000ms (1s)
