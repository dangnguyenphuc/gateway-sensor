...
ADAFRUIT_ACCESS_TOKEN = "aio_wrEX93GXzIhSrbBOsFOU5JQeMFzJ"
PORT = 1883

feed_status = "dangnguyen/feeds/nmdk-1-fanstatus-1"
feed_value = "dangnguyen/feeds/nmdk-1-fanvalue-1"
    ...
    with sr.Microphone() as source:
        try:
            ...
            if predictions[0][0] > 0.5:
                client.publish(feed_status, "ON")
            else: 
                client.publish(feed_status, "OFF")
            return
        except:
            tts = gTTS(text = "Xin lỗi, tôi không hiểu bạn nói gì",lang='vi')
            play(tts)
