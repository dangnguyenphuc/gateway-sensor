...
jsons = "json"
feedID = {
    "nmdk-1-fanstatus-1": 2463386,
    "nmdk-1-ledstatus-1": 2463387,
    "nmdk-1-doorstatus-1": 2494057,
    "nmdk-1-tempsensor-1": 2462542,
    "nmdk-1-lightsensor-1": 2464202,
    "nmdk-1-ledvalue-1" : 2470613,
    "nmdk-1-fanvalue-1" : 2470612,
    "nmdk-1-soundai" : 12
}
# ---------------------------------------------------------------------
...
while True:
    ...
    client.publish(feed + AIO_FEED_PUBLISH[0], float(splitData[1]))
    client.publish(feed + AIO_FEED_PUBLISH[1], float(splitData[3]))
    client.publish(feed + AIO_FEED_PUBLISH[2], float(splitData[1]))
    client.publish(feed + AIO_FEED_PUBLISH[3], float(splitData[3]))
    client.publish(feed + AIO_FEED_PUBLISH[4], float(splitData[1]))
    client.publish(feed + AIO_FEED_PUBLISH[5], float(splitData[3]))
    client.publish(feed + AIO_FEED_PUBLISH[6], float(splitData[1]))
    client.publish(feed + AIO_FEED_PUBLISH[7], float(splitData[3]))
    time.sleep(5)
