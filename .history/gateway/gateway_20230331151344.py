...
sensor_collection.insert_one({"timestamp": f'{current_time}', "temp": int('23,7'), "light" : int(32)})
################ DATA QUERY EXAMPLE ################
...
#         sensor_collection.insert_one({"timestamp": f'{current_time}', "temp": int(splitData[1]), "light" : int(splitData[3])})
...
#                 fan_collection.insert_one({"timestamp": f'{current_time}', "status": "ON", "value": int(splitData[3])})
#             else: 
...
#                 Bub_collection.insert_one({"timestamp": f'{current_time}', "status": "ON", "value": int(splitData[3])})
#             else: 
#                 # client.publish(feed + AIO_FEED_PUBLISH[7], 0)
#                 Bub_collection.insert_one({"timestamp": f'{current_time}', "status": "OFF", "value": 0})
