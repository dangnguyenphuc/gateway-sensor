...
class Dashboard:
    def __init__(self, window):
        ...
        self.ani = FuncAnimation(plt.gcf(), self.animate, interval=1000, blit=False)
        self.canvas.place(x=40, y=70)
    ...
    def animate(self, i):
        ...
        self.ax1, self.ax2 = plt.gcf().get_axes()
        # Clear current data
        self.ax1.cla()
        self.ax2.cla()
        # Plot new data
        self.ax1.plot(x_vals, y_vals)
        self.ax2.plot(x_vals, y_vals2)
