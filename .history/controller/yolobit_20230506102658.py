...
# Mô tả hàm này...
def b3():
  global t_C3_ADn_hi_E1_BB_87u, b3_list, b1_list, b2_list, received_list, default_fan_value, ACK_b1_flag, ACK_temp_li_flag, ACK_b2_flag, cmd, temp, default_light_value, ACK_b3_flag, light_status, door_status, fan_status, fan_value, light_value, lux, current_color, temp_light_list, b1_ack_time, teli_ack_time, b2_ack_time, b3_ack_time, status, color_counter, color_list, aiot_ir_rx, aiot_dht20, aiot_lcd1602, tiny_rgb
...
def on_event_timer_callback_d_t_W_A_C():
  global t_C3_ADn_hi_E1_BB_87u, b3_list, b1_list, b2_list, received_list, default_fan_value, ACK_b1_flag, ACK_temp_li_flag, ACK_b2_flag, cmd, temp, default_light_value, ACK_b3_flag, light_status, door_status, fan_status, fan_value, light_value, lux, current_color, temp_light_list, b1_ack_time, teli_ack_time, b2_ack_time, b3_ack_time, status, color_counter, color_list
...
def Light_on():
  global t_C3_ADn_hi_E1_BB_87u, b3_list, b1_list, b2_list, received_list, default_fan_value, ACK_b1_flag, ACK_temp_li_flag, ACK_b2_flag, cmd, temp, default_light_value, ACK_b3_flag, light_status, door_status, fan_status, fan_value, light_value, lux, current_color, temp_light_list, b1_ack_time, teli_ack_time, b2_ack_time, b3_ack_time, status, color_counter, color_list, aiot_ir_rx, aiot_dht20, aiot_lcd1602, tiny_rgb
  if light_value >= 100:
    tiny_rgb.show(0, hex_to_rgb(current_color))
  elif light_value >= 70:
    tiny_rgb.show(1, hex_to_rgb(current_color))
    tiny_rgb.show(2, hex_to_rgb(current_color))
    tiny_rgb.show(3, hex_to_rgb(current_color))
  elif light_value >= 40:
    tiny_rgb.show(1, hex_to_rgb(current_color))
    tiny_rgb.show(2, hex_to_rgb(current_color))
  elif light_value > 0:
...
def on_ir_receive_callback(t_C3_ADn_hi_E1_BB_87u, addr, ext):
  global b3_list, b1_list, b2_list, received_list, default_fan_value, ACK_b1_flag, ACK_temp_li_flag, ACK_b2_flag, cmd, temp, default_light_value, ACK_b3_flag, light_status, door_status, fan_status, fan_value, light_value, lux, current_color, temp_light_list, b1_ack_time, teli_ack_time, b2_ack_time, b3_ack_time, status, color_counter, color_list
  ...
  if aiot_ir_rx.get_code() == IR_REMOTE_SETUP:
    color_counter = color_counter % 8 + 1
    current_color = color_list[int(color_counter - 1)]
...
event_manager.add_timer_event(200, on_event_timer_callback_l_J_T_D_h)

# Mô tả hàm này...
def Open_Door():
  global t_C3_ADn_hi_E1_BB_87u, b3_list, b1_list, b2_list, received_list, default_fan_value, ACK_b1_flag, ACK_temp_li_flag, ACK_b2_flag, cmd, temp, default_light_value, ACK_b3_flag, light_status, door_status, fan_status, fan_value, light_value, lux, current_color, temp_light_list, b1_ack_time, teli_ack_time, b2_ack_time, b3_ack_time, status, color_counter, color_list, aiot_ir_rx, aiot_dht20, aiot_lcd1602, tiny_rgb
  if door_status == 'ON':
    pin4.servo_write(120)
  else:
    pin4.servo_write(0)

def on_event_condition_callback_J_J_C_C_o():
  global t_C3_ADn_hi_E1_BB_87u, b3_list, b1_list, b2_list, received_list, default_fan_value, ACK_b1_flag, ACK_temp_li_flag, ACK_b2_flag, cmd, temp, default_light_value, ACK_b3_flag, light_status, door_status, fan_status, fan_value, light_value, lux, current_color, temp_light_list, b1_ack_time, teli_ack_time, b2_ack_time, b3_ack_time, status, color_counter, color_list
  Light_on()

event_manager.add_condition_event(lambda:(light_status == 'ON'), on_event_condition_callback_J_J_C_C_o)
...
if True:
  ...
  light_value = 0
  color_counter = 8
  color_list = ['#FF0000', '#FFA500', '#FFFF00', '#00FF00', '#0000FF', '#4B0082', '#800080', '#FFFFFF']
  current_color = color_list[int(color_counter - 1)]
