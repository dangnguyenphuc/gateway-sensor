...
# create an NSSpeechSynthesizer object
...
synth.setRate_(200)
synth.setVolume_(0.5)

# convert text to speech
text = "Hello, how are you today?"
synth.startSpeakingString_(Foundation.NSString.stringWithString_(text))

# wait for speech to finish
while synth.isSpeaking():
    pass

# deallocate the NSSpeechSynthesizer object
synth.release()